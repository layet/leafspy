...
/**
 * leaf_spy_car get Id by VIN number
 * @param $VIN Car VIN to search id
 * @access public
 * @return Car id if exists
 */
function getCarIdByVIN($VIN) {
   return SQLSelectOne('select `Id` from `leaf_spy_cars` where `VIN` = \''.DbSafe($VIN).'\'')['Id'];
}
/**
 * leaf_spy_car Insert new car record
 * @param $data Retrieved data from Leaf Spy
 * @access public
 */
...
/**
 * leaf_spy_car Update car record
 * @param $car_id Car Id
 * @param $data Retrieved data from Leaf Spy
 * @access public
 */
